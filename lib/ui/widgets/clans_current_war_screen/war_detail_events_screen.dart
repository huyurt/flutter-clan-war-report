  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        final opponentMember = opponent.members?.firstWhere((member) =>
            member.tag == attack.attackerTag ||
            member.tag == attack.defenderTag);
        final clanAttacker = clanMember?.tag == attack.attackerTag;

        final clanMemberTownhallLevel = (clanMember?.townhallLevel ?? 1) > 11
              ...
              Expanded(
                ...
                child: SizedBox(
                  ...
                  child: Card(
                    ...
                    elevation: 0.0,
                    color: clanAttacker
                        ? bgColor ?? AppConstants.attackerDefaultBackgroundColor
                        : Colors.transparent,
                    ...
                    child: InkWell(
                      onTap: () {
                        if (!(clanMember?.tag.isEmptyOrNull ?? true)) {
                          PlayerDetailScreen(
              ...
              Expanded(
                ...
                child: SizedBox(
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        if (!(opponentMember?.tag.isEmptyOrNull ?? true)) {
                          PlayerDetailScreen(
