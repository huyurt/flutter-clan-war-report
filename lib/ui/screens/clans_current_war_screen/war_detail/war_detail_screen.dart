      ...
      body: BlocBuilder<ClanCurrentWarDetailBloc, ClanCurrentWarDetailState>(
        builder: (context, state) {
          ...
          if (state is ClanCurrentWarDetailStateSuccess) {
            WarClan clan;
            WarClan opponent;
            if (state.clanCurrentWarDetail.war.clan.tag == widget.clanTag) {
              clan = state.clanCurrentWarDetail.war.clan;
              opponent = state.clanCurrentWarDetail.war.opponent;
            } else {
              clan = state.clanCurrentWarDetail.war.opponent;
              opponent = state.clanCurrentWarDetail.war.clan;
            }
