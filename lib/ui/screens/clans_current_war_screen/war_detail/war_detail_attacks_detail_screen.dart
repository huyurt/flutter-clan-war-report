...
class WarDetailAttacksDetailScreen extends StatefulWidget {
  const WarDetailAttacksDetailScreen({
    super.key,
    required this.clan,
  ...
  @override
  State<WarDetailAttacksDetailScreen> createState() =>
      _WarDetailAttacksDetailScreenState();
}

class _WarDetailAttacksDetailScreenState
    extends State<WarDetailAttacksDetailScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(tr(LocaleKey.clanWar)),
      ),
      body: ListView(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        tr(LocaleKey.bestOpponentAttack),
                        style: const TextStyle(fontSize: 12.0),
                      ),
                    ],
                  ),
                ...
                Visibility(
                  visible: memberAttacks.isNotEmpty ||
                      memberDefenceAttacks.isNotEmpty,
                  child: SizedBox(
                    height: 300,
                    child: Chart(
                      rebuild: true,
